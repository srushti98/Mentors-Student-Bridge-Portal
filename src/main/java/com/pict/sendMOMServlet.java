...
@WebServlet("/sendMOMServlet")
public class sendMOMServlet extends HttpServlet {
    private Connection databaseConnection;
    private int flag=0;

    public sendMOMServlet(){
        super();
...
//            Date date1= (Date) simpleDateFormat.parse(date);
            ...
            preparedStatement=con.prepareStatement("insert into activity_list (mentor_id, activity_name, activity_date, activity_title, activity_content) values(?, 'MOM', ?, ?, ?)");
            ...
            while (resultSet.next()){
                String file_content="<!DOCTYPE html>\n" +
                        ...
                        "\n" +
                        "<h4>The mentor has sent the Minutes of Meeting</h4>\n" +
                        "\n" +
                        "<br><a href=\"http://localhost:8080\" class=\"button\">Check It Out!</a>\n" +
                        "\n" +
                        "</body>\n" +
        ...
        if (flag==1)
            response.sendRedirect("/forms/mentor_mom.jsp");
    }
