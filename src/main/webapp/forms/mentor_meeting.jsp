...
<nav class="navbar navbar-expand-lg " >
    ...
    <div class="collapse navbar-collapse" id="navbarColor03" >
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item ">
                <a class="nav-link active" style="color: white" href="/forms/mentor_meeting.jsp"><strong><b>Arrange a meeting</b></strong></a>
            </li>
            <li class="nav-item">
                <a class="nav-link " style="color: white" href="/forms/mentor_mom.jsp"><strong><b>Send MOM</b></strong></a>
            </li>
            <li class="nav-item">
