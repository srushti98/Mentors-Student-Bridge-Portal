...
<nav class="navbar navbar-expand-lg " >
    ...
    <div class="collapse navbar-collapse" id="navbarColor03" >
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link active" style="color: white" href="/forms/mentor_mom.jsp"><strong><b>Send MOM</b></strong></a>
            </li>
            <li class="nav-item">
...
<div id="container" style="padding: 2px;margin-top: 90px">
    <h1 style="margin-top: 50px">&bull; Minutes Of Meeting &bull;</h1>
    <div class="underline">
    </div>
    <div class="icon_wrapper">

    </div>
    <form action="/sendMOMServlet" method="post" id="contact_form">
        <div class="name">

            <input type="text" placeholder="TITLE OF MOM" name="name" id="name_input" required>
        </div>
        <div class="meeting_date_of_mom">

            <input type="date" placeholder="MEETING DATE" name="meeting_date_of_mom" id="date_input" required>
        </div>
